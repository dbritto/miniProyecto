 ...
 * @author Cristhian
 */
public class VistaSupervisorInsumos extends JFrame{
 private Container contenedor;
    public JButton bgenerar, bvolver, bpedido;
    public JComboBox boxreporte;
    private String reportes[]={"", "Cantidad Menor a 5","Descripcion", "Proximo a Vencer"};
